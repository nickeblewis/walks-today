...
function (_Component) {
  ...
  function MuxVideoInputUploader() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(MuxVideoInputUploader)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "dragEnteredEls", []);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "upload", null);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "ctrlDown", false);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "cancelUploadButton", _react.default.createRef());
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "hiddenTextField", _react.default.createRef());
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleProgress", function (evt) {
      if (evt.percent) {
        _this.setState({
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleUploadFile", function (file) {
      _this.setState({
        uploadProgress: 0,
        fileInfo: null,
        uuid: null
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleUploadEvent", function (event) {
      switch (event.type) {
        case 'success':
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleUploadSuccess", function (assetDocument) {
      _this.setState({
        uploadProgress: 100
      });
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handlePaste", function (event) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleDrop", function (event) {
      _this.setState({
        isDraggingOver: false
      });
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleDragOver", function (event) {
      event.preventDefault();
      event.stopPropagation();
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleDragEnter", function (event) {
      event.stopPropagation();
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleDragLeave", function (event) {
      event.stopPropagation();
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleCancelUploadButtonClicked", function (event) {
      _this.setState({
        uploadProgress: null,
        error: null
      });
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleErrorClose", function (event) {
      if (event) {
        event.preventDefault();
      }
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleSetupButtonClicked", function (event) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handleKeyUp", function (event) {
      if (event.keyCode == ctrlKey || event.keyCode == cmdKey) {
  ...
  (0, _createClass2.default)(MuxVideoInputUploader, [{
    ...
    value: function renderUploadProgress() {
      ...
      return _react.default.createElement("div", {
        ...
        animation: true,
        color: "primary"
      })), (uploadProgress < 100 || this.state.error) && _react.default.createElement("div", {

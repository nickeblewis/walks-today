...
var _default = (0, _formBuilder.withDocument)(
/*#__PURE__*/
function (_Component) {
  ...
  function MuxVideoInput(_props) {
    ...
    _this2 = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(MuxVideoInput).call(this, _props));
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)), "focus", function () {
      _this2.setState({
        hasFocus: true
      });
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)), "blur", function () {
      _this2.setState({
        hasFocus: false
      });
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)), "pollMux", function () {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)), "handleSetupButtonClicked", function (event) {
      _this2.setState({
        showSetup: true
      });
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)), "handleSaveSetup", function (_ref2) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)), "handleCancelSaveSetup", function () {
      _this2.setState({
        showSetup: false
      });
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)), "handleOnUploadComplete", function (result) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)), "handleRemoveVideoButtonClicked", function (event) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)), "handleRemoveVideo", function () {
      var assetDocument = _this2.state.assetDocument;
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)), "handleCancelRemove", function (event) {
      _this2.setState({
        confirmRemove: false,
        deleteOnMuxChecked: true,
        deleteAssetDocumentChecked: true
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)), "handleDeleteOnMuxCheckBoxClicked", function (event) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)), "handleDeleteAssetDocumentCheckBoxClicked", function (event) {
      _this2.setState(function (prevState) {
        return {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)), "handleSetThumbButton", function (event) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)), "handleErrorClose", function (event) {
      if (event) {
        event.preventDefault();
      }
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)), "handleCloseThumbPreview", function (event) {
      _this2.setState({
        thumb: null
      });
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)), "handleBrowseButton", function (event) {
      _this2.setState({
        showBrowser: true
      });
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)), "handleCloseBrowser", function (event) {
      _this2.setState({
        showBrowser: false
      });
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)), "handleSelectAsset", function (asset) {
      var onChange = _this2.props.onChange;
      onChange(_patchEvent.default.from([(0, _patchEvent.setIfMissing)({
        asset: {
          _ref: asset._id
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this2)), "handleVideoReadyToPlay", function () {
      _this2.setState({
  ...
  (0, _createClass2.default)(MuxVideoInput, [{
    ...
    value: function renderVideoButtons() {
      ...
      if (assetDocument && assetDocument.status === 'ready' && !readOnly) {
        return _react.default.createElement(_react.Fragment, null, _react.default.createElement(_default2.default, {
          inverted: true,
          kind: "default",
          onClick: this.handleBrowseButton,
          title: "Select a previous uploaded video"
        }, "Browse"), _react.default.createElement(_default2.default, {
          inverted: true,
        ...
        }, "Set thumb"), _react.default.createElement(_default2.default, {

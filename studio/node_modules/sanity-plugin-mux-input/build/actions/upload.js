      ...
      return (0, _rxjs.concat)((0, _rxjs.of)({
        ...
        (0, _operators.mergeMap)(function (event) {
          ...
          (0, _operators.mergeMap)(function (doc) {
            return (0, _rxjs.of)((0, _objectSpread2.default)({}, event, {
              asset: doc
            }));
          }));
...
function _updateAssetDocumentFromUpload() {
  _updateAssetDocumentFromUpload = (0, _asyncToGenerator2.default)(
  /*#__PURE__*/
  _regenerator.default.mark(function _callee2(uuid) {

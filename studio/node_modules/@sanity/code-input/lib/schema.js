...
class Input extends _react.PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(CodeInput, _extends({
      ref: this.codeInput
    }, this.props));
  }
...
var Preview = props => {
  ...
  return /*#__PURE__*/_react.default.createElement(PreviewCode, props);
};
...
function getMedia(language) {
  ...
  if (language === 'json') {
    return /*#__PURE__*/_react.default.createElement(_jsonLogo.default, null);
  }

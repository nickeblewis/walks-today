(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('part:@sanity/components/buttons/default-style'), require('part:@sanity/components/loading/spinner'), require('part:@sanity/components/buttons/button-grid-style'), require('react-dom'), require('part:@sanity/components/dialogs/fullscreen-style'), require('react'), require('part:@sanity/components/loading/spinner-style'), require('part:@sanity/base/spinner-icon')) :
    typeof define === 'function' && define.amd ? define(['part:@sanity/components/buttons/default-style', 'part:@sanity/components/loading/spinner', 'part:@sanity/components/buttons/button-grid-style', 'react-dom', 'part:@sanity/components/dialogs/fullscreen-style', 'react', 'part:@sanity/components/loading/spinner-style', 'part:@sanity/base/spinner-icon'], factory) :
    (global.sanityPluginAssetSourceThispersondoesnotexist = factory(global.defaultStyle,global.spinner,global.buttonGridStyle,global.reactDom,global.fullscreenStyle,global.React,global.spinnerStyle,global.spinnerIcon));
}(this, (function (defaultStyle,spinner,buttonGridStyle,reactDom,fullscreenStyle,React,spinnerStyle,spinnerIcon) { 'use strict';
    ...
    spinnerStyle = spinnerStyle && spinnerStyle.hasOwnProperty('default') ? spinnerStyle['default'] : spinnerStyle;
    spinnerIcon = spinnerIcon && spinnerIcon.hasOwnProperty('default') ? spinnerIcon['default'] : spinnerIcon;
    ...
    */
    ...
    var Button = unwrapExports(DefaultButton);
    ...
    var _spinnerStyle = _interopRequireDefault(spinnerStyle);

    var _spinnerIcon = _interopRequireDefault(spinnerIcon);
    ...
    var css$1 = ".AIFaceAssetSource_root__12UcL {\n  height: calc(100vh - 7rem);\n}\n\n.AIFaceAssetSource_wrapper__3gmgn {\n  width: 600px;\n  height: 100%;\n}\n\n.AIFaceAssetSource_image__1vz-l {\n  display: none;\n}\n\n.AIFaceAssetSource_canvas__ODwB0 {\n  display: block;\n  max-height: 600px;\n}\n\n.AIFaceAssetSource_buttons__wDRnG {\n  margin-bottom: 30px;\n}\n";
    var styles = {"root":"AIFaceAssetSource_root__12UcL","wrapper":"AIFaceAssetSource_wrapper__3gmgn","image":"AIFaceAssetSource_image__1vz-l","canvas":"AIFaceAssetSource_canvas__ODwB0","buttons":"AIFaceAssetSource_buttons__wDRnG"};
    styleInject(css$1);
    ...
    var AIFaceAssetSource = /** @class */ (function (_super) {
        ...
        AIFaceAssetSource.prototype.handleSaveImage = function () {
            var canvas$$1 = this.canvasRef.current;
            if (!canvas$$1) {
                console.log('Error: No canvas!');
                return;
            }
            var value = canvas$$1.toDataURL();
            var asset = {
                kind: 'base64',
                value: value,
                assetDocumentProps: {
        ...
        AIFaceAssetSource.prototype.render = function () {
            ...
            return (React.createElement(Dialog, { title: "Select face from thispersondoesnotexist.com", onClose: this.handleClose, isOpen: true },
                React.createElement("div", { className: styles.root },
                    React.createElement("div", { className: styles.buttons },
                        React.createElement(Button, { disabled: isLoading, onClick: function () {
                                return _this.setState({ isLoading: true, cacheBuster: _this.state.cacheBuster + 1 });
                            } }, "Generate new"),
                        React.createElement(Button, { disabled: isLoading || !didLoad, onClick: function () {
                                _this.handleSaveImage();
                            } }, "Pick this one")),
                    React.createElement("div", { className: styles.wrapper },
                        isLoading && React.createElement(Spinner, { inline: true }),
                        React.createElement("canvas", { className: styles.canvas, ref: this.canvasRef, width: 1024, height: 1024 })),
                    React.createElement("img", { onError: function () { return _this.setState({ isLoading: false }); }, onLoad: function () { return _this.handleImageLoaded(); }, ref: this.imgRef, src: url, crossOrigin: "anonymous", className: styles.image }))));
        };
...
//# sourceMappingURL=sanity-plugin-asset-source-thispersondoesnotexist.umd.js.map
